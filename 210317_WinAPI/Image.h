...
public:
	...
	void Render3(HDC hdc, int destX = 0, int destY = 0,
		bool isCenterRenderring = false, float maxPer=100, float nowPer=100);
	void Render2(HDC hdc, int destX = 0, int destY = 0,
		bool isCenterRenderring = false, float size = 0.0f);
	...
	void AlphaRender(HDC hdc, int destX, int destY,
		bool isCenterRenderring = false);
	void AlphaRender2(HDC hdc, int destX, int destY, bool isCenterRenderring, int currFrameX, float size);
